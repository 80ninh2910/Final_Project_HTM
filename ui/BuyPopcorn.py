...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 888, 3012))
...
"    padding: 5px")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("D:\\FINAL_OFFICIAL\\ui\\../images/ic_popcorn.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
